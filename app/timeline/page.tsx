      ...
      data={[
        {
          ...
          content: (
            <div className="grid grid-cols-1 gap-2">
              <p>
                Started work on prisma-idb, an <b>npm package</b> that makes it
                easier to query IndexedDB with Prisma&apos;s familiar and powerful
                API.
              </p>
              {/* <MiniProjectShowcase projectName="PRISMA IDB" />
               *create the Prisma-IDB project file and MDX
               */}
            </div>
          ),
        },
        ...
        },
        {
          ...
          content: (
            <div className="grid grid-cols-1 gap-2">
              ...
              <MiniProjectShowcase projectName="TrackMate" />
            </div>
          ),
        },
        {
          ...
          content: (
            <div className="grid grid-cols-1 gap-2">
              <p>
                Started work on V2 of MyFit. A second, yet naive, attempt using{" "}
                <b>DaisyUI</b> and <b>MongoDB</b> with <b>SvelteKit</b>.
              </p>
          ...
          content: (
            <div className="grid grid-cols-1 gap-2">
              <p>
                ...
                Engineering Intern. Utilized <b>Python</b> and <b>Pandas</b> for
        ...
        },
        {
          ...
          content: (
            <div className="grid grid-cols-1 gap-2">
              <p>Designed a static, high-performance website for my college.</p>
              <MiniProjectShowcase projectName="Agnel-Polytechnic-Website" />
            </div>
          ),
        },
        {
        ...
        },
        {
          ...
          content: (
            <div className="grid gap-2">
              ...
              <MiniProjectShowcase projectName="Cryptocurrencies-Handbook" />
            </div>
          ),
        },
        {
