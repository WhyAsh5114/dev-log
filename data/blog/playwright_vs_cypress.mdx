export const metadata = {
  title: "Playwright versus Cypress",
  description: "Just started using Playwright, feels really nice",
  author: "Yash Kolekar",
...
Testing software is a must; often, I've made changes and broken something unknowingly, making it extra annoying to trace
down what went wrong. Testing helps avoid all that and is also oddly pleasing; those green checkmarks appearing one by
...
<div className="flex w-full justify-center my-2 border">
  <img src="/blogs/testing.png" width="500" />
</div>
